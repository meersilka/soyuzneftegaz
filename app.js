  ...
  function header() {
    return (
      '<div class="notice-bar"><div class="container">' +
        "<span>Учебный контур: каталог, остатки, цены и список складов — демонстрационный набор данных. " +
        "Реквизиты, телефон и город — настоящие. Боевые позиции подставляются из 1С.</span>" +
      "</div></div>" +
